...
urlpatterns = [
    ...
    path('spatial_top_cn_variance/', visualization_views.SpatialTopCNVarianceView.as_view(),
         name='spatial-top-cn-variance'),
    ...
    path('pathway_enrichment_options/', visualization_views.PathwayEnrichmentPlotOptionsView.as_view(),
         name='pathway-enrichment-options'),
    path('pathway_enrichment_plot/', visualization_views.PathwayEnrichmentPlotView.as_view(),
         name='pathway-enrichment-plot'),
]
