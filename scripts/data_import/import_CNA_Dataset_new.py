...
def import_CNA_Dataset(file_path):
    ...
    column_mapping = {
        ...
        "c_workflow": "workflow",
        "c_cn_type": "cn_type",
        "c_raw_cn_scale": "raw_cn_scale",
        "c_raw_locus_type": "raw_locus_type",
        ...
        "n_cell_num": "cell_num",
        "n_spot_num": "spot_num",
        "n_after_qc_ratio": "after_qc_ratio",
        "c_usage_permission": "usage_permission"
    }
    ...
    for _, row in dataset_df.iterrows():
        ...
        for excel_col, model_field in column_mapping.items():
            ...
            # 浮动字段处理 (例如: after_qc_ratio)
            elif model_field == "after_qc_ratio":
                try:
                    value = float(value) if pd.notnull(value) and value != '' else None
                except (ValueError, TypeError):
                    value = None
...
if __name__ == '__main__':
    data_file_path = './CNAScope table - Dataset Metadata.csv'
